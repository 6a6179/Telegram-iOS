    ...
    public init(
        ...
        self.presentationDataDisposable = combineLatest(
            ...
            if let strongSelf = self {
                ...
                if isFirstTime || previousTheme != presentationData.theme || previousStrings !== presentationData.strings || presentationData.chatWallpaper != previousChatWallpaper || previousUsernameDisplay != presentationData.usernameDisplay {
